/datum/map/site42
	...
	usable_email_tlds = list("site42.foundation", "security.site42.foundation", "science.site42.foundation", "utility.site42.foundation")
	config_path = "config/site42_config.txt"

	allowed_spawns = list("Cryogenic Storage")
	default_spawn = "Cryogenic Storage"

	station_name  = "Foundation Site 42"
	station_short = "Site 42"
	...
	apc_test_exempt_areas = list(
		/area/space = NO_APC
		/*
		/area/site42/llcz/mine/unexplored = NO_APC,
		/area/site42/llcz/mine/explored = NO_APC,
		/area/site42/surface = NO_APC,
		/area/turbolift/site42/surface = NO_APC,
		/area/turbolift/site42/basement = NO_APC,
		/area/turbolift/site42/scp106obs = NO_APC,
		/area/turbolift/site42/scp106obs = NO_APC,
		/area/turbolift/site42/uhcz = NO_APC,
		/area/turbolift/site42/lhcz = NO_APC,
		/area/site42/tram/scpcar = NO_APC,
		/area/turbolift/site42/commstower = NO_APC,
		/area/turbolift/site42/scp106cont = NO_APC,
		/area/turbolift/site42/robotlwr = NO_APC,
		/area/turbolift/site42/robotupr = NO_APC,
		/area/turbolift/site42/gatea = NO_APC,
		/area/turbolift/site42/hub = NO_APC,
		/area/centcom/goc = NO_APC,
		/area/turbolift/site42/up082 = NO_APC,
		/area/turbolift/site42/low82 = NO_APC
		*/
	)
