...
/obj/machinery/telecomms/receiver/preset_right
	...
	freq_listening = list(AI_FREQ, SCI_FREQ, MED_FREQ, SUP_FREQ, SRV_FREQ, COMM_FREQ, SEC_FREQ, ENG_FREQ, ENT_FREQ, SEC_HCZ_FREQ, SEC_LCZ_FREQ, SEC_ECZ_FREQ, GOC_FREQ, ERT_FREQ)
