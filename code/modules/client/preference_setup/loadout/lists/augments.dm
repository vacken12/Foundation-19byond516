...
/datum/gear/augment/integrated_health_hud
	...
	allowed_roles = list(/datum/job/cmo, /datum/job/chemist, /datum/job/surgeon, /datum/job/emt, /datum/job/psychiatrist, /datum/job/medicaldoctor, /datum/job/enlistedofficerlcz, enlistedofficerhcz, enlistedofficerez, /datum/job/ncoofficerez, /datum/job/ncoofficerhcz, /datum/job/ncoofficerlcz)
